...
export default function PricingIntro({}: Props) {
  return (
    <div className="flex flex-col rounded-xl lg:rounded-none p-10 lg:py-80 gap-8 lg:p-44 lg:gap-6 mt-10 lg:pt-16 justify-center items-center text-white bg-gradient-to-r from-spotpurple to-engagepurple mx-6 lg:mx-0">
      <h1 className="font-semibold lg:text-4xl xl:text-5xl text-center leading-10 text-3xl">
        Simple Pricing
      </h1>
      <p className="lg:text-sm text-center text-xs 2xl:px-32 xl:px-48 lg:px-28 sm:px-16 md:px-28">
